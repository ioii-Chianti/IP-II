...
// wolves, goats and cabbages at the left bank of the river. 012
// The fourth to sixth components denote the current numbers
// of wolves, goats and cabbages at the right bank. 345
// The seventh component denotes the location of the boat:
// 1 means "left bank" and -1 means "right bank". 6
